...
class Car:
  ...
  def controls_update(self, CS: car.CarState, CC: car.CarControl):
    ...
    if self.sm.all_alive(['carControl']):
      ...
      try:
          self.last_actuators_output, can_sends = self.CI.apply(CC, self.sm['carControl'], now_nanos)
      except TypeError:
          self.last_actuators_output, can_sends = self.CI.apply(CC, self.sm['carControl'])  # Fallback
